                        ...
                        <div className="flex w-full items-center gap-1">
                          ...
                          <ContextMenu>
                            ...
                            <ContextMenuContent className="z-[1100]">
                              ...
                              {isAdmin && onRecomputePerformance && (
                                <ContextMenuItem onSelect={() => onRecomputePerformance(f.id)}>
                                  <BarChart3 className="mr-2 h-3.5 w-3.5" />
                                  Recalcular análisis de performance…
                                </ContextMenuItem>
                              )}
                              {(() => {
...
const ParqueLayerToggle = () => {
  ...
  return (
    ...
    >
      ...
      <span className="font-mono text-[10px] text-text-muted">8.1M</span>
      <IOSSwitch on={visible} />
    </button>
  );
};
