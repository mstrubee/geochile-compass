...
import {
  ...
  AlertTriangle, ArrowLeft, ExternalLink, Link as LinkIcon,
} from "lucide-react";
import {
    ...
    <div className="rounded-xl border border-border/60 bg-surface/60 p-4">
      <div className="mb-3 flex items-center justify-between">
        <div>
          ...
          <p className="text-[11px] text-muted-foreground">Se muestran en el menú del encabezado.</p>
        </div>
  ...
  return (
    <div className="min-h-screen bg-background text-foreground">
      <div className="mx-auto max-w-5xl p-6">
        ...
        <h1 className="font-display text-2xl font-semibold">Gemini API Keys</h1>
