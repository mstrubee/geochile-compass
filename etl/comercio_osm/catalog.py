...
_BRAND_RULES: list[tuple[str, BrandEntry]] = [
    ...
    # ─── FERRETERÍA ──────────────────────────────────────────────────────────
    ("sodimac homecenter",  _entry("Sodimac",        "ferreteria", "gran_superficie", "Falabella", "#F5821F", "🔨")),
    ("sodimac constructor", _entry("Sodimac",        "ferreteria", "gran_superficie", "Falabella", "#F5821F", "🔨")),
    ("sodimac",             _entry("Sodimac",        "ferreteria", "gran_superficie", "Falabella", "#F5821F", "🔨")),
    ("easy",                _entry("Easy",           "ferreteria", "gran_superficie", "Cencosud",  "#E31837", "🔨")),
    ("construmart",         _entry("Construmart",    "ferreteria", "gran_superficie", "",          "#0066CC", "🔨")),
    ("ferretería mts",      _entry("Red MTS",        "ferreteria", "ferreteria",      "RedMTS",    "#7C3AED", "🔨")),
    ("ferreteria mts",      _entry("Red MTS",        "ferreteria", "ferreteria",      "RedMTS",    "#7C3AED", "🔨")),
    ("mts ferretería",      _entry("Red MTS",        "ferreteria", "ferreteria",      "RedMTS",    "#7C3AED", "🔨")),
    ("mts ferreteria",      _entry("Red MTS",        "ferreteria", "ferreteria",      "RedMTS",    "#7C3AED", "🔨")),
    ("mts",                 _entry("Red MTS",        "ferreteria", "ferreteria",      "RedMTS",    "#7C3AED", "🔨")),
    ("volter",              _entry("Volter",         "ferreteria", "ferreteria",      "RedMTS",    "#7C3AED", "🔨")),
    ("imperial",            _entry("Imperial",       "ferreteria", "ferreteria",      "",          "#B45309", "🔨")),
    ("chilemat",            _entry("Chilemat",       "ferreteria", "ferreteria",      "",          "#D97706", "🔨")),
    ("ferrosur",            _entry("Ferrosur",       "ferreteria", "ferreteria",      "",          "#6B7280", "🔨")),
    ("homecenter",          _entry("Sodimac",        "ferreteria", "gran_superficie", "Falabella", "#F5821F", "🔨")),

    # ─── GAS (distribución cilindros) ────────────────────────────────────────
    ("abastible",           _entry("Abastible",      "gas",        "gas",             "Abastible", "#F59E0B", "🔥")),
    ("gasco",               _entry("Gasco",          "gas",        "gas",             "Gasco",     "#E31837", "🔥")),
    ("lipigas",             _entry("Lipigas",        "gas",        "gas",             "Lipigas",   "#0066CC", "🔥")),
